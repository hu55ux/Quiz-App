...
public class QuizGameDBContext : DbContext
{
    ...
    public List<Result> results = new List<Result>
    {
        ...
        new Result { UserId = 16, QuizId = 1, Score = 12 },
        new Result { UserId = 16, QuizId = 2, Score = 20 },
        new Result { UserId = 16, QuizId = 3, Score = 14 },
        new Result { UserId = 16, QuizId = 4, Score = 16 },

        new Result { UserId = 17, QuizId = 1, Score = 17 },
        new Result { UserId = 17, QuizId = 2, Score = 13 },
        new Result { UserId = 17, QuizId = 3, Score = 15 },
        new Result { UserId = 17, QuizId = 4, Score = 19 },

        new Result { UserId = 18, QuizId = 1, Score = 16 },
        new Result { UserId = 18, QuizId = 2, Score = 12 },
        new Result { UserId = 18, QuizId = 3, Score = 18 },
        new Result { UserId = 18, QuizId = 4, Score = 14 },

        new Result { UserId = 19, QuizId = 1, Score = 15 },
        new Result { UserId = 19, QuizId = 2, Score = 17 },
        new Result { UserId = 19, QuizId = 3, Score = 13 },
        new Result { UserId = 19, QuizId = 4, Score = 20 },

        new Result { UserId = 20, QuizId = 1, Score = 14 },
        new Result { UserId = 20, QuizId = 2, Score = 16 },
        new Result { UserId = 20, QuizId = 3, Score = 12 },
        new Result { UserId = 20, QuizId = 4, Score = 18 },

        new Result { UserId = 21, QuizId = 1, Score = 19 },
        new Result { UserId = 21, QuizId = 2, Score = 15 },
        new Result { UserId = 21, QuizId = 3, Score = 17 },
        new Result { UserId = 21, QuizId = 4, Score = 13 },

        new Result { UserId = 22, QuizId = 1, Score = 12 },
        new Result { UserId = 22, QuizId = 2, Score = 18 },
        new Result { UserId = 22, QuizId = 3, Score = 14 },
        new Result { UserId = 22, QuizId = 4, Score = 16 },

        new Result { UserId = 23, QuizId = 1, Score = 17 },
        new Result { UserId = 23, QuizId = 2, Score = 13 },
        new Result { UserId = 23, QuizId = 3, Score = 15 },
        new Result { UserId = 23, QuizId = 4, Score = 19 },

        new Result { UserId = 24, QuizId = 1, Score = 16 },
        new Result { UserId = 24, QuizId = 2, Score = 12 },
        new Result { UserId = 24, QuizId = 3, Score = 20 },
        new Result { UserId = 24, QuizId = 4, Score = 14 },

        new Result { UserId = 25, QuizId = 1, Score = 15 },
        new Result { UserId = 25, QuizId = 2, Score = 17 },
        new Result { UserId = 25, QuizId = 3, Score = 13 },
        new Result { UserId = 25, QuizId = 4, Score = 18 },

        new Result { UserId = 26, QuizId = 1, Score = 14 },
        new Result { UserId = 26, QuizId = 2, Score = 16 },
        new Result { UserId = 26, QuizId = 3, Score = 12 },
        new Result { UserId = 26, QuizId = 4, Score = 19 },

        new Result { UserId = 27, QuizId = 1, Score = 17 },
        new Result { UserId = 27, QuizId = 2, Score = 13 },
        new Result { UserId = 27, QuizId = 3, Score = 15 },
        new Result { UserId = 27, QuizId = 4, Score = 20 },

        new Result { UserId = 28, QuizId = 1, Score = 16 },
        new Result { UserId = 28, QuizId = 2, Score = 12 },
        new Result { UserId = 28, QuizId = 3, Score = 18 },
        new Result { UserId = 28, QuizId = 4, Score = 14 }
